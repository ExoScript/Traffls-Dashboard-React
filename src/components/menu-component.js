    ...
    <div className="menu-component-menu-component">
      <div className="menu-component-container border_bottom">
        <div className="menu-component-container01">
          <span className="menu-component-text">traffls</span>
          <span className="menu-component-text01">Dashboard</span>
        </div>
        <div className="menu-component-container02">
          ...
          <span className="menu-component-text02 opacity_06">Search</span>
        </div>
      </div>
      <div className="menu-component-container03">
        <div className="menu-component-container04">
          <div
            ...
            className="menu-component-container05"
          >
            ...
            <div className="menu-component-container07">
              {!mailCloud && (
              ...
              {mailCloud && (
                <svg viewBox="0 0 1024 1024" className="opacity_06 icon_15">
          ...
          {mailCloud && (
            <div className="menu-component-container08">
              <div className="menu-component-container09">
                <div className="menu-component-container10"></div>
              </div>
              <div className="menu-component-container11">
                <div className="menu-component-container12">
                  <span>Overview</span>
                </div>
        ...
        <div className="menu-component-container17">
          <div
            ...
            className="menu-component-container18"
          >
            ...
            <div className="menu-component-container20">
              {!nearCloud && (
                <svg viewBox="0 0 1024 1024" className="icon_15 opacity_06">
                  <path d="M316 366l196 196 196-196 60 60-256 256-256-256z"></path>
                </svg>
          ...
          {nearCloud && (
            <div className="menu-component-container21">
              <div className="menu-component-container22">
                <div className="menu-component-container23"></div>
              </div>
              <div className="menu-component-container24">
                <div className="menu-component-container25">
                  <span>Overview</span>
                </div>
